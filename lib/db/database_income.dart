    ...
    return openDatabase(
      ...
      onCreate: (database, version) async {
        await database.execute(
          "CREATE TABLE transactions(id INTEGER PRIMARY KEY AUTOINCREMENT, trans TEXT NOT NULL, date TEXT NOT NULL, account TEXT NOT NULL, category TEXT NOT NULL, amount INTEGER NOT NULL, note TEXT)",
        );
      },
      version: 1,
    );
