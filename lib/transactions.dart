                ...
                onTap: () async {
                  await showDatePicker(
                    ...
                    if (selectedDate != null) {
                      ...
                      setState(() {});
                      handler.initializeDB().whenComplete(() async {
                        late final _dateYear = _dateController.text
                            .substring(8, _dateController.text.length);
                        late final _dateMonth = _dateController.text
                            .substring(0, _dateController.text.length - 9);
                        ...
                        for (int j = 0; j < databaseList.length; j++) {
                          final String dateIs = databaseList[j]['date']
                              ...
                              .substring(
                                  0,
                                  databaseList[j]['date'].toString().length -
                                      9);
                          final String dateLast = databaseList[j]['date']
                              .toString()
                              .substring(
                                  8, databaseList[j]['date'].toString().length);
                          if (dateIs == _dateMonth &&
                              dateLast == _dateYear &&
                              databaseList[j]['trans'] == 'income') {
                            final double value = double.parse(
                                databaseList[j]['amount'].toString());
                            total = total + value;
                          }
                        }
                        income = total;
